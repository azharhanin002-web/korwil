  ...
  if (!post) {
    return (
      <div className="container mx-auto py-40 text-center">
        <h1 className="text-3xl font-black text-gray-300 uppercase tracking-widest mb-6 italic">Informasi PGRI Tidak Ditemukan</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        <header className="pt-16 pb-10">
          <div className="flex justify-start mb-6">
            <div className="inline-flex items-center gap-2 bg-red-100 text-red-700 text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-[0.2em] shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {post.related && post.related.length > 0 ? (
              post.related.slice(0, 4).map((rel: any) => (
                <Link href={`/pgri/${rel.slug}`} key={rel._id} className="group flex flex-col h-full bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-100">
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <h4 className="text-[13px] font-black text-[#002040] leading-snug group-hover:text-red-600 line-clamp-2 uppercase">
                      {rel.title}
                    </h4>
              ...
              <p className="col-span-full text-gray-400 italic text-sm">Belum ada kabar terkait lainnya.</p>
            )}
          </div>
        </div>
        ...
        <div className="mt-20 flex justify-center">
          <Link href="/pgri" className="group flex items-center gap-3 text-xs font-black text-[#002040] uppercase tracking-[0.3em] hover:text-red-600 transition-colors">
